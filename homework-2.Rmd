...
female_abalone <- data.frame(longest_shell=0.50, diameter=0.10, height=0.30,
                  whole_weight=4, shucked_weight=1, viscera_weight=2, shell_weight=1, type='F')

predict(lm_fit, female_abalone)
```
...
The r-squared is 0.55 which means our model doesn't really fit our training set. 
